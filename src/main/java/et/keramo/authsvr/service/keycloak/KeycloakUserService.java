...
@Slf4j
@Service
@Qualifier("keycloakUserService")
public class KeycloakUserService extends AbstractDataService {
    ...
    public Object list(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return this.postRequest(
                this.freeIpaUrl + SecurityConstants.FREE_IPA_JSON_PATH,
                this.makeHeader(),
                this.makeBody(SecurityConstants.FREE_IPA_USER_LIST_METHOD)
        );
    }

    @Override
    public Object get(HttpServletRequest request, HttpServletResponse response, String username) throws Exception {
        this.preAuthentication();

        return this.postRequest(
                this.freeIpaUrl + SecurityConstants.FREE_IPA_JSON_PATH,
                this.makeHeader(),
                this.makeBody(SecurityConstants.FREE_IPA_USER_GET_METHOD, username)
        );
    }

    @Override
    public Object add(HttpServletRequest request, HttpServletResponse response, Map<String, Object> user) throws Exception {
        this.preAuthentication();

        return this.postRequest(
                this.freeIpaUrl + SecurityConstants.FREE_IPA_JSON_PATH,
                this.makeHeader(),
                this.makeBody(SecurityConstants.FREE_IPA_USER_ADD_METHOD, user)
        );
    }

    @Override
    public Object update(HttpServletRequest request, HttpServletResponse response, Map<String, Object> user) throws Exception {
        this.preAuthentication();

        return this.postRequest(
                this.freeIpaUrl + SecurityConstants.FREE_IPA_JSON_PATH,
                this.makeHeader(),
                this.makeBody(SecurityConstants.FREE_IPA_USER_UPDATE_METHOD, user)
        );
    }

    @Override
    public Object delete(HttpServletRequest request, HttpServletResponse response, String username) throws Exception {
        this.preAuthentication();

        return this.postRequest(
                this.freeIpaUrl + SecurityConstants.FREE_IPA_JSON_PATH,
                this.makeHeader(),
                this.makeBody(SecurityConstants.FREE_IPA_USER_DELETE_METHOD, username)
        );
    }
